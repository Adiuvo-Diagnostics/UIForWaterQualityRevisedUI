...
class HomeScreen(BaseScreen):
    def __init__(self, master, app_instance):
        ...
        wifi_button = tk.Button(self, image=self.wifi_image, command=self.show_wifi_dialog, borderwidth=0)
        ...
        start_button = tk.Button(self, image=self.start_image, command=self.start_new_experiment, borderwidth=0)
        ...
        exps_button = tk.Button(self, image=self.exps_image, command=self.view_experiment, borderwidth=0)
        ...
        config_button = tk.Button(self, image=self.config_image, command=self.config, borderwidth=0)
        ...
        ShutDown_button = tk.Button(self, image=self.ShutDown_image, command=self.shutdown, borderwidth=0)
